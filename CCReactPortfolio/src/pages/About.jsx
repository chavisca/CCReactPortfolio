export default function About() {
    return (
        <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
            ...
            <h2 className="text-2xl md:text-xl mb-3 font-medium">The Charles Chavis Story</h2>
            <p className="text-base md:text-xl mb-3 font-medium">Accountant by day, Full-Stack Web Developer by night.</p>
